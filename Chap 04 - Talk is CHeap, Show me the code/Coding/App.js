...
import BiteFoodLogo  from "../Images/Bite Food.png"
...
const Title = () =>{
    <a href='/'>
        <img className='logo' src={BiteFoodLogo} alt='Bite Food logo'/>
    </a>
};
...
// Body Component for Body secctions: it contain all restaurant cards
// we are mapping restauratList array and passing data to restauratCard as props with unique key as index
